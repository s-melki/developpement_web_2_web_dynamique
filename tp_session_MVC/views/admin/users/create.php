    ...
    <div class="container">
        <div class="card">
            ...
            <form action="../controllers/userController.php?action=create" method="POST">
                ...
                <input type="text" id="username" name="username" required placeholder="ex: ibtissem">

                <label for="email">Adresse email</label>
                <input type="email" id="email" name="email" required placeholder="ex: ibtissem@mail.com">

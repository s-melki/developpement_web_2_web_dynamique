...
?>
    ...
    <div class="container">
        <div class="top-bar">
              ...
              <a href="../controllers/userController.php?action=create" class="btn btn-danger"> + Nouvel utlisateur</a>
        </div>
        <table>
        <thead>
            <tr>
                ...
                <tr>
                     <td><?php echo $u["id"]; ?></td>
                        <td><strong><?php echo htmlspecialchars($u["username"]); ?></strong></td>
                           ...
                           <td><strong><?php echo htmlspecialchars($u["role"]); ?></strong></td>
                           <td><strong><?php echo date("d/m/Y",strtotime($u["created_at"])); ?></strong></td>
                           <td>
                            <a href="../controllers/userController.php?action=edit&id=<?php echo $u["id"] ?>" class="btn btn-warning">Modifier</a>
                            <a href="../controllers/userController.php?action=delete&id=<?php echo $u["id"] ?>" class="btn btn-danger">Supprimer</a>
                           </td>
                </tr>
                <?php endforeach; ?>
        </tbody>
